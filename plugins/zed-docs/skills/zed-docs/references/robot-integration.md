...
# → /{robot_id}/cam/zed_node/...
```

| 기능 | standalone (기본) | plem 통합 (robot_id=indy) |
|------|-------------------|--------------------------|
| 이미지 | `/zed/zed_node/rgb/color/rect/image` | `/indy/cam/zed_node/rgb/color/rect/image` |
| Point Cloud | `/zed/zed_node/point_cloud/cloud_registered` | `/indy/cam/zed_node/point_cloud/cloud_registered` |
| OD | `/zed/zed_node/obj_det/objects` | `/indy/cam/zed_node/obj_det/objects` |
| OD 서비스 | `/zed/zed_node/enable_obj_det` | `/indy/cam/zed_node/enable_obj_det` |
...
# 기본: /{ROBOT_ID}/cam/zed_node/obj_det/objects
